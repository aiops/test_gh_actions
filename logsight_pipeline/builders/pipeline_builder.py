...
from logsight_pipeline.pipeline import Pipeline
...
class PipelineBuilder(Builder):
    ...
    def build(self, pipeline_config: PipelineProperties) -> Pipeline:
        """
    ...
    def _build_connectors(self, connectors: PipelineConnectorsProperties) -> Tuple[PipelineSourceAdapter,
    ...
    def _build_modules(self, modules_cfg: Dict[str, ModuleConfigProperties]) -> Dict[str, Module]:
        """
    ...
    @staticmethod
    def _infer_input_module(modules_cfg: Dict[str, ModuleConfigProperties]) -> str:
        """
    ...
    @staticmethod
    def _connect_modules(modules: Dict[str, Module],
                         modules_config: Dict[str, ModuleConfigProperties]) -> Dict[str, Module]:
        """
